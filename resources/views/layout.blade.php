...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('assets/img/logodaninventaris.png') }}">
  <link rel="icon" type="image/png" href="{{ asset('assets/img/logodaninventaris.png') }}">
  <title>
    Aplikasi Inventaris 18350
  </title>
  <!--     Fonts and icons     -->
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html " target="_blank">
        <img src="{{ asset('assets/img/logodaninventaris.png') }}" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">Inventaris 18350</span>
      </a>
    </div>
    ...
    <!-- Pegembalian -->
        ...
        <li class="nav-item">
          <a class="nav-link " href="./pages/profile.html">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        <i class="fa-solid fa-rotate-right text-primary text-sm opacity-10"></i>
            </div>
    ...
    <!-- Pegembalian -->
        ...
        <li class="nav-item">
          <a class="nav-link " href="./pages/profile.html">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        <i class="fa-solid fa-table-list text-primary text-sm opacity-10"></i>
            </div>
